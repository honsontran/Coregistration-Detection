"""
Mask R-CNN
Train on the spine segmentation dataset from the
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 spine.py train --dataset=/path/to/dataset --subset=train --weights=imagenet

    # Train a new model starting from specific weights file
    python3 spine.py train --dataset=/path/to/dataset --subset=train --weights=/path/to/weights.h5

    # Resume training a model that you had trained earlier
    python3 spine.py train --dataset=/path/to/dataset --subset=train --weights=last
...
class SpineConfig(Config):
    ...
    NUM_CLASSES = 1 + 1  # Background + spine
...
def detect(model, dataset_dir, subset):
    ...
    dataset.load_spine(dataset_dir, subset)
    dataset.prepare()
    # Load over images
    submission = []
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Mask R-CNN for spine counting and segmentation')
